  ...
  if (bodyLockStatus) {
    ...
    setTimeout(() => {
      lockPaddingElements.forEach((lockPaddingElement) => {
        const type = lockPaddingElement.dataset.flsLpType;
        if (type === "right") {
          lockPaddingElement.style.right = "";
        } else {
...
let bodyLock = (delay = 500) => {
  if (bodyLockStatus) {
    ...
    lockPaddingElements.forEach((lockPaddingElement) => {
      const type = lockPaddingElement.dataset.flsLpType;
      if (type === "right") {
        const computedRight = window.getComputedStyle(lockPaddingElement).right;
        const currentRight = parseFloat(computedRight) || 0;
        lockPaddingElement.style.right = `${currentRight + lockPaddingValue}px`;
      } else {
        const computedPadding = window.getComputedStyle(lockPaddingElement).paddingRight;
        const currentPadding = parseFloat(computedPadding) || 0;
        lockPaddingElement.style.paddingRight = `${currentPadding + lockPaddingValue}px`;
      }
    });
    const bodyComputedPadding = window.getComputedStyle(document.body).paddingRight;
    const bodyCurrentPadding = parseFloat(bodyComputedPadding) || 0;
    document.body.style.paddingRight = `${bodyCurrentPadding + lockPaddingValue}px`;
...
function handleMenuArrowsClick(e) {
  ...
  clickedItem.classList.toggle("_active", !isActive);
}
function updateMenuArrowHandlers() {
  document.querySelectorAll(".menu__arrow-box").forEach((menuArrow) => {
    const newArrow = menuArrow.cloneNode(true);
    menuArrow.replaceWith(newArrow);
    newArrow.addEventListener("click", handleMenuArrowsClick);
  });
}
if (menuButton) {
...
class ScrollWatcher {
  ...
  // Функція обробки базових дій точок спрацьовування original
  /*
  ...
  if (preloaderImages.length && !isPreloaded) {
    ...
    const preloaderTemplate = `
			<div class="fls-preloader">
				...
				<div class="fls-preloader__text">Jacob<span>Grønberg</span></div>
...
var lgFullscreen_min$1 = { exports: {} };
/**
 * lightgallery | 2.9.0-beta.1 | June 15th 2025
 * http://www.lightgalleryjs.com/
 * Copyright (c) 2020 Sachin Neravath;
 * @license GPLv3
 */
var lgFullscreen_min = lgFullscreen_min$1.exports;
var hasRequiredLgFullscreen_min;
function requireLgFullscreen_min() {
  if (hasRequiredLgFullscreen_min) return lgFullscreen_min$1.exports;
  hasRequiredLgFullscreen_min = 1;
  (function(module, exports) {
    !function(e, l) {
      module.exports = l();
    }(lgFullscreen_min, function() {
      var e = function() {
        return (e = Object.assign || function(e2) {
          for (var l2, n = 1, t = arguments.length; n < t; n++) for (var c in l2 = arguments[n]) Object.prototype.hasOwnProperty.call(l2, c) && (e2[c] = l2[c]);
          return e2;
        }).apply(this, arguments);
  ...
  return lgFullscreen_min$1.exports;
}
var lgFullscreen_minExports = requireLgFullscreen_min();
const lgFullscreen = /* @__PURE__ */ getDefaultExportFromCjs(lgFullscreen_minExports);
var lgRotate_min$1 = { exports: {} };
/**
 * lightgallery | 2.9.0-beta.1 | June 15th 2025
 * http://www.lightgalleryjs.com/
 * Copyright (c) 2020 Sachin Neravath;
 * @license GPLv3
 */
var lgRotate_min = lgRotate_min$1.exports;
var hasRequiredLgRotate_min;
function requireLgRotate_min() {
  if (hasRequiredLgRotate_min) return lgRotate_min$1.exports;
  hasRequiredLgRotate_min = 1;
  (function(module, exports) {
    !function(t, e) {
      module.exports = e();
    }(lgRotate_min, function() {
      var t = function() {
        return (t = Object.assign || function(t2) {
      ...
      }, e = "lgSlideItemLoad", i = "lgBeforeSlide", o = "lgRotateLeft", r = "lgRotateRight", s = "lgFlipHorizontal", a = "lgFlipVertical", l = { rotate: true, rotateSpeed: 400, rotateLeft: true, rotateRight: true, flipHorizontal: true, flipVertical: true, rotatePluginStrings: { flipVertical: "Flip vertical", flipHorizontal: "Flip horizontal", rotateLeft: "Rotate left", rotateRight: "Rotate right" } };
      return function() {
        function n(e2, i2) {
          return this.core = e2, this.$LG = i2, this.settings = t(t({}, l), this.core.settings), this;
        }
        return n.prototype.buildTemplates = function() {
          var t2 = "";
          this.settings.flipVertical && (t2 += '<button type="button" id="lg-flip-ver" aria-label="' + this.settings.rotatePluginStrings.flipVertical + '" class="lg-flip-ver lg-icon"></button>'), this.settings.flipHorizontal && (t2 += '<button type="button" id="lg-flip-hor" aria-label="' + this.settings.rotatePluginStrings.flipHorizontal + '" class="lg-flip-hor lg-icon"></button>'), this.settings.rotateLeft && (t2 += '<button type="button" id="lg-rotate-left" aria-label="' + this.settings.rotatePluginStrings.rotateLeft + '" class="lg-rotate-left lg-icon"></button>'), this.settings.rotateRight && (t2 += '<button type="button" id="lg-rotate-right" aria-label="' + this.settings.rotatePluginStrings.rotateRight + '" class="lg-rotate-right lg-icon"></button>'), this.core.$toolbar.append(t2);
        }, n.prototype.init = function() {
          var t2 = this;
          this.settings.rotate && (this.buildTemplates(), this.rotateValuesList = {}, this.core.LGel.on(e + ".rotate", function(e2) {
            var i2 = e2.detail.index;
            t2.core.getSlideItem(i2).find(".lg-img-rotate").get() || (t2.core.getSlideItem(i2).find(".lg-object").first().wrap("lg-img-rotate"), t2.core.getSlideItem(t2.core.index).find(".lg-img-rotate").css("transition-duration", t2.settings.rotateSpeed + "ms"));
          }), this.core.outer.find("#lg-rotate-left").first().on("click.lg", this.rotateLeft.bind(this)), this.core.outer.find("#lg-rotate-right").first().on("click.lg", this.rotateRight.bind(this)), this.core.outer.find("#lg-flip-hor").first().on("click.lg", this.flipHorizontal.bind(this)), this.core.outer.find("#lg-flip-ver").first().on("click.lg", this.flipVertical.bind(this)), this.core.LGel.on(i + ".rotate", function(e2) {
            t2.rotateValuesList[e2.detail.index] || (t2.rotateValuesList[e2.detail.index] = { rotate: 0, flipHorizontal: 1, flipVertical: 1 });
          }));
        }, n.prototype.applyStyles = function() {
          this.core.getSlideItem(this.core.index).find(".lg-img-rotate").first().css("transform", "rotate(" + this.rotateValuesList[this.core.index].rotate + "deg) scale3d(" + this.rotateValuesList[this.core.index].flipHorizontal + ", " + this.rotateValuesList[this.core.index].flipVertical + ", 1)");
        }, n.prototype.rotateLeft = function() {
          this.rotateValuesList[this.core.index].rotate -= 90, this.applyStyles(), this.triggerEvents(o, { rotate: this.rotateValuesList[this.core.index].rotate });
        }, n.prototype.rotateRight = function() {
          this.rotateValuesList[this.core.index].rotate += 90, this.applyStyles(), this.triggerEvents(r, { rotate: this.rotateValuesList[this.core.index].rotate });
        }, n.prototype.getCurrentRotation = function(t2) {
          if (!t2) return 0;
          var e2 = this.$LG(t2).style(), i2 = e2.getPropertyValue("-webkit-transform") || e2.getPropertyValue("-moz-transform") || e2.getPropertyValue("-ms-transform") || e2.getPropertyValue("-o-transform") || e2.getPropertyValue("transform") || "none";
          if ("none" !== i2) {
            var o2 = i2.split("(")[1].split(")")[0].split(",");
            if (o2) {
              var r2 = Math.round(Math.atan2(o2[1], o2[0]) * (180 / Math.PI));
              return r2 < 0 ? r2 + 360 : r2;
            }
          }
          return 0;
        }, n.prototype.flipHorizontal = function() {
          var t2 = this.core.getSlideItem(this.core.index).find(".lg-img-rotate").first().get(), e2 = this.getCurrentRotation(t2), i2 = "flipHorizontal";
          90 !== e2 && 270 !== e2 || (i2 = "flipVertical"), this.rotateValuesList[this.core.index][i2] *= -1, this.applyStyles(), this.triggerEvents(s, { flipHorizontal: this.rotateValuesList[this.core.index][i2] });
        }, n.prototype.flipVertical = function() {
          var t2 = this.core.getSlideItem(this.core.index).find(".lg-img-rotate").first().get(), e2 = this.getCurrentRotation(t2), i2 = "flipVertical";
          90 !== e2 && 270 !== e2 || (i2 = "flipHorizontal"), this.rotateValuesList[this.core.index][i2] *= -1, this.applyStyles(), this.triggerEvents(a, { flipVertical: this.rotateValuesList[this.core.index][i2] });
        }, n.prototype.triggerEvents = function(t2, e2) {
          var i2 = this;
          setTimeout(function() {
            i2.core.LGel.trigger(t2, e2);
          }, this.settings.rotateSpeed + 10);
        }, n.prototype.isImageOrientationChanged = function() {
          var t2 = this.rotateValuesList[this.core.index], e2 = Math.abs(t2.rotate) % 360 != 0, i2 = t2.flipHorizontal < 0, o2 = t2.flipVertical < 0;
          return e2 || i2 || o2;
        }, n.prototype.closeGallery = function() {
          this.isImageOrientationChanged() && this.core.getSlideItem(this.core.index).css("opacity", 0), this.rotateValuesList = {};
        }, n.prototype.destroy = function() {
  ...
  return lgRotate_min$1.exports;
}
var lgRotate_minExports = requireLgRotate_min();
const lgRotate = /* @__PURE__ */ getDefaultExportFromCjs(lgRotate_minExports);
...
function initGallery() {
  ...
  galleries.forEach((galleryEl) => {
    ...
    galleryEl.addEventListener("lgBeforeOpen", () => {
      bodyLock();
    });
...
function pageNavigation() {
  ...
  function pageNavigationAction(e) {
    ...
    if (e.type === "click" && targetElement.closest("[data-fls-scrollto]")) {
      const gotoLink = targetElement.closest("[data-fls-scrollto]");
      const gotoLinkSelector = gotoLink.dataset.flsScrollto || "";
      const isExternalPage = gotoLinkSelector.includes(".html#");
      ...
      if (window.fullpage) {
        const fullpageSection = (_a = document.querySelector(`${gotoLinkSelector}`)) == null ? void 0 : _a.closest("[data-fls-fullpage-section]");
    ...
    if (e.type === "watcherCallback" && e.detail) {
      ...
      const targetElement2 = entry.target;
      if (targetElement2.dataset.flsWatcher === "navigator") {
        document.querySelector(
          `[data-fls-scrollto].--navigator-active`
        );
        let navigatorCurrentItem;
        if (targetElement2.id && document.querySelector(`[data-fls-scrollto="#${targetElement2.id}"]`)) {
          navigatorCurrentItem = document.querySelector(
            `[data-fls-scrollto="#${targetElement2.id}"]`
          );
        } else if (targetElement2.classList.length) {
          for (let index = 0; index < targetElement2.classList.length; index++) {
            const element = targetElement2.classList[index];
        ...
        if (entry.isIntersecting) {
          navigatorCurrentItem == null ? void 0 : navigatorCurrentItem.classList.add("--navigator-active");
        } else {
          navigatorCurrentItem == null ? void 0 : navigatorCurrentItem.classList.remove("--navigator-active");
        }
      }
    }
  }
  function gotoHashNavigation() {
    const hash = getHash();
    const scrollInfo = sessionStorage.getItem("scrollToHash");
    let offsetTop = 0;
    let noHeader = false;
    let speed = 500;
    let hashSelector = "";
    if (scrollInfo) {
      try {
        const parsed = JSON.parse(scrollInfo);
        offsetTop = parsed.offsetTop || 0;
        noHeader = parsed.noHeader || false;
        speed = parsed.speed || 500;
        hashSelector = parsed.hash ? `#${parsed.hash}` : "";
      } catch (err) {
      }
    ...
    if (hashSelector) {
      scrollTo(0, 0);
      const tryScroll = () => {
        if (document.querySelector(hashSelector)) {
          gotoBlock(hashSelector, noHeader, speed, offsetTop);
